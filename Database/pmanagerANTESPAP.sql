...
--
-- Host: localhost:3306
-- Generation Time: 11-Jul-2019 às 22:41
...
--
-- Extraindo dados da tabela `issuefollow`
--

INSERT INTO `issuefollow` (`idIssue`, `idUser`) VALUES
(5, 8),
(8, 8);
...
(8, 14, 'Criador pode alterar seu role', 'Proibir criador alterar o seu role', 2, 8, 8, '2019-07-05 23:53:12', '2019-07-10 00:55:02');
...
--
-- Extraindo dados da tabela `milestones`
--

INSERT INTO `milestones` (`id`, `idProject`, `name`, `idStatus`, `targetDate`, `idCreator`, `creationDate`, `idUpdateUser`, `lastupdateDate`) VALUES
(1, 27, 'Objetivo #1', 4, '2020-05-01', 8, '2019-07-11 22:35:32', 8, '2019-07-11 22:35:32');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mstatus`
--
...
--
-- Extraindo dados da tabela `mstatus`
--

INSERT INTO `mstatus` (`id`, `name`, `badge`) VALUES
(1, 'Completed', 'success'),
(2, 'Incompleted', 'danger'),
(3, 'Cancelled', 'warning'),
(4, 'In Progress', 'success');
...
(3, 'Um titulo', 'saddsadasdas', 'eftzvzijl7e6', 3, 8, '2019-06-26 01:00:00', 13, '2019-07-09 16:55:57'),
(14, 'Project Manager', 'Projeto PAP do aluno Miguel', 'o58ry09smun6', 4, 8, '2019-07-04 12:33:13', 8, '2019-07-10 00:28:11'),
(23, 'Revamp', 'FB Revamp', 'zgubrnky9673', 2, 17, '2019-07-10 20:06:39', 17, '2019-07-10 20:06:39'),
(27, 'Projeto Exemplo', 'Uma descriÃ§Ã£o de um projeto', 'ea9drk3ma567', 2, 8, '2019-07-11 22:21:40', 8, '2019-07-11 22:21:40');
...
INSERT INTO `reports` (`id`, `code`, `description`, `idUser`, `creationDate`) VALUES
(4, 'dsasdadsa', 'sdasaddsasdadsadassdasdadsadsasdadsasaddsasadsda', 8, '2019-07-10 21:11:33'),
(5, 'saddsaads', 'dsasdasadsadsaddasadsasdsdaasdsdasad', 8, '2019-07-10 21:12:29'),
(6, NULL, 'Um problema que aconteceu hoje', 8, '2019-07-11 10:10:59');
...
(15, 2, 8, 'assaddas', '2019-07-09 17:03:11', NULL),
(17, 1, 8, 'vfgffg', '2019-07-11 10:08:42', NULL);
...
--
-- Extraindo dados da tabela `taskfollow`
--

INSERT INTO `taskfollow` (`idTask`, `idUser`) VALUES
(1, 8),
(2, 8),
(20, 8),
(30, 8),
...
(2, 3, 'Danger', 'Danger testedsadsa', 2, 8, 13, '2019-06-30 01:00:00', '2019-07-09 16:55:54'),
...
(20, 14, 'Adicionar novos status', 'Tanto para o projeto como para o resto', 1, 8, 8, '2019-07-04 00:43:45', '2019-07-07 22:15:33'),
...
(36, 14, 'Make user filter project name', 'In all projects make user write project name and search for it', 4, 8, 8, '2019-07-07 20:21:55', '2019-07-10 16:14:55'),
(39, 27, 'Exemplo tarefa #1', 'Uma tarefa fixe', 1, 8, 8, '2019-07-11 22:23:45', '2019-07-11 22:23:45'),
(40, 27, 'tarefa #2', 'Preciso criar uma tabela', 4, 8, 8, '2019-07-11 22:24:09', '2019-07-11 22:24:09');
...
(17, 'tiago-messi1@hotmail.com', 'Blkout', '2019-07-10 08:06:14', '2019-07-10 08:06:14', 216, '0'),
(18, 'jose@gmail.com', 'joseverissimo', '2019-07-11 08:51:13', '2019-07-11 08:51:13', NULL, '0'),
(21, 'gfgeraldes@hotmail.com', 'Guilherme', '2019-07-11 12:55:20', '2019-07-11 12:55:20', NULL, '0'),
(22, 'viewer@mail.com', 'TEMPaccount', '2019-07-11 07:15:41', '2019-07-11 07:15:41', NULL, '0');
...
(17, '$2y$12$RC6ZKbz8fwzYElM1BB3HZOB/TSS4vawDbsKa1biKzmVEksgGuDCPW', 'lulmao?', '$2y$12$JxsmViSZQxYDxpKcDuujlOUSPMZWpMCi2HCwnaM5TUEq7ZC9w/esu'),
(18, '$2y$12$ODvgu8g.LgmCJZEBQ8MtY.O7nrwkh97OiZtIgDqZNktGdK6W524yu', 'benfica', '$2y$12$HuxMhv0hIvo42TLWrJ5XduE3Nppx7Z1cR0aSSlCH6k.g.fEtRqilm'),
(21, '$2y$12$juNtVNyKgejI1/9aNa5yueDnbVEbdGCMV3D81v/bSna342XmUokT2', 'Animal favorito?', '$2y$12$74OlLyaIPNGLTmRuFvSidOQ1qzjPWrrH/1WW3O3kYygrZjnf1Oc0O'),
(22, '$2y$12$.e/2Be4kEIpurGKu7sFNJO04Gy.Z1JWah2aDGZNTiMipiZKawhQd6', 'asddsdas', '$2y$12$6zhB2VoSsN3iyct1xXKSduswhcjau5ifihs0EqFdfc1D7e4vAP5mq');
...
ALTER TABLE `taskfollow`
  ...
  ADD KEY `taskfollow_ibfk_2` (`idUser`);
...
--
ALTER TABLE `issuecomments`
  ADD CONSTRAINT `issuecomments_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `issuecomments_ibfk_2` FOREIGN KEY (`idIssue`) REFERENCES `issues` (`id`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `issuefollow`
--
ALTER TABLE `issuefollow`
  ADD CONSTRAINT `issuefollow_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `issuefollow_ibfk_2` FOREIGN KEY (`idIssue`) REFERENCES `issues` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `issues`
  ...
  ADD CONSTRAINT `issues_ibfk_2` FOREIGN KEY (`idProject`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `issues_ibfk_3` FOREIGN KEY (`idCreator`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `issues_ibfk_4` FOREIGN KEY (`idUpdateUser`) REFERENCES `user` (`id`);

--
-- Limitadores para a tabela `milestones`
--
ALTER TABLE `milestones`
  ADD CONSTRAINT `milestones_ibfk_1` FOREIGN KEY (`idStatus`) REFERENCES `mstatus` (`id`),
  ADD CONSTRAINT `milestones_ibfk_2` FOREIGN KEY (`idCreator`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `milestones_ibfk_3` FOREIGN KEY (`idUpdateUser`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `milestones_ibfk_4` FOREIGN KEY (`idProject`) REFERENCES `projects` (`id`);

--
-- Limitadores para a tabela `projectmembers`
--
ALTER TABLE `projectmembers`
  ADD CONSTRAINT `projectmembers_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `projectmembers_ibfk_2` FOREIGN KEY (`idProject`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `projects`
  ADD CONSTRAINT `projects_ibfk_1` FOREIGN KEY (`idCreator`) REFERENCES `user` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `taskcomments`
  ADD CONSTRAINT `taskcomments_ibfk_1` FOREIGN KEY (`idTask`) REFERENCES `tasks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `taskcomments_ibfk_2` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `taskfollow`
--
ALTER TABLE `taskfollow`
  ADD CONSTRAINT `taskfollow_ibfk_1` FOREIGN KEY (`idTask`) REFERENCES `tasks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `taskfollow_ibfk_2` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `tasks`
--
ALTER TABLE `tasks`
  ADD CONSTRAINT `tasks_ibfk_1` FOREIGN KEY (`idProject`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tasks_ibfk_2` FOREIGN KEY (`idCreator`) REFERENCES `user` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `usersecurity`
  ADD CONSTRAINT `usersecurity_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE;
